...
# import database
df = pd.read_csv("../Unsupervised algos/Mall_Customers.csv")
print(df.head())
...
df_scale = pd.DataFrame(
    scale, columns=['Annual Income (k$)', 'Spending Score (1-100)'])
print(df_scale.head())
...
sns.scatterplot(x="Spending Score (1-100)", y="Annual Income (k$)",
                hue='Clusters',  data=df, palette='viridis')
plt.show()
